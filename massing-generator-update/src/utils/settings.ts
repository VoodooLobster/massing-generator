...
export const DEFAULT_APP_SETTINGS: AppSettings = {
  ...
  isometric3D: {
    retail: {
      primary: "#8b8b8b",      // dark gray
      accent: "#585858",       // darker gray
      glass: "#c2c2c2",        // light gray glass
    },
    residential: {
      primary: "#ff8844",      // warm orange
      accent: "#fd5000",       // darker orange
      glass: "#e6f1fb",        // light blue glass
    },
    office: {
      primary: "#5a7ab3",      // steel blue
      accent: "#3d5a99",       // darker blue
      glass: "#d4e4f7",        // light glass
    },
    mixed_use: {
      primary: "#8b7f4c",      // warm taupe
      accent: "#6b6140",       // darker taupe
      glass: "#e8e4d5",        // cream glass
    },
    border: "#333333",         // dark lines
